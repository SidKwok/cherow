...
Parser.prototype.parseScript = function parseScript (context) {
    ...
    var node = {
        type: 'Program',
        body: this.parseStatementList(context | 4 /* AllowIn */, 0 /* EndOfSource */),
        sourceType: 'script'
    };
    if (this.flags & 8192 /* OptionsRanges */) {
        node.start = 0;
...
Parser.prototype.skipComments = function skipComments (state) {
    ...
    if (state & 12 /* Collectable */ && this.flags & 1048576 /* OptionsOnComment */) {
...
Parser.prototype.scanNumberLiteral = function scanNumberLiteral (context) {
    ...
    if (!(this.flags & 512 /* Noctal */))
        { this.flags |= 512 /* Noctal */; }
    this.advance();
...
Parser.prototype.scanNumber = function scanNumber (context) {
    ...
    if (this.nextChar() === 46 /* Period */) {
        if (!(this.flags & 2048 /* Float */))
            { this.flags |= 2048 /* Float */; }
        this.advance();
        this.skipDigits();
    }
    var end = this.index;
    switch (this.nextChar()) {
        ...
        case 101 /* LowerE */:
            this.advance();
            if (!(this.flags & 4096 /* Exponent */))
                { this.flags |= 4096 /* Exponent */; }
            // scan exponent
            switch (this.nextChar()) {
                case 43 /* Plus */:
                case 45 /* Hyphen */:
    ...
    if (this.flags & 131072 /* OptionsRaw */)
        { this.tokenRaw = raw; }
    this.tokenValue = this.flags & 6144 /* FloatOrExponent */ ? parseFloat(raw) : parseInt(raw, 10);
    return 262146 /* NumericLiteral */;
};
...
Parser.prototype.parseStatementList = function parseStatementList (context, endToken) {
    ...
    while (this.token !== endToken) {
        ...
        if (item.expression.value === 'use strict') {
            ...
            if (this$1.flags & 256 /* FirstRestricted */)
...
Parser.prototype.isLexical = function isLexical (context) {
    ...
    // or [.
    this.peekToken(context);
    return this.peekedToken === 393217 /* Identifier */ || hasMask(this.peekedToken, 131072 /* BindingPattern */);
};
...
Parser.prototype.parseExportDefault = function parseExportDefault (context, pos) {
    ...
    switch (this.token) {
        ...
        case 274519 /* FunctionKeyword */:
            declaration = this.parseFunctionDeclaration(context |= (65536 /* OptionalIdentifier */ | 32768 /* Export */));
            break;
        // export default ClassDeclaration[Default]
        case 274509 /* ClassKeyword */:
            declaration = this.parseClassDeclaration(context | (65536 /* OptionalIdentifier */ | 32768 /* Export */));
            break;
        // export default HoistableDeclaration[Default]
...
Parser.prototype.parseExportDeclaration = function parseExportDeclaration (context) {
    ...
    switch (this.token) {
        ...
        case 274509 /* ClassKeyword */:
            declaration = this.parseClassDeclaration(context | 32768 /* Export */);
            break;
        // export LexicalDeclaration
        case 8663113 /* ConstKeyword */:
            declaration = this.parseVariableStatement(context |= (16777216 /* Const */ | 4194304 /* RequireInitializer */));
            break;
        // export LexicalDeclaration
        case 8671304 /* LetKeyword */:
            declaration = this.parseVariableStatement(context |= (8388608 /* Let */ | 4194304 /* RequireInitializer */));
            break;
        // export VariableDeclaration
        case 8663111 /* VarKeyword */:
            declaration = this.parseVariableStatement(context | 4194304 /* RequireInitializer */ | 32768 /* Export */);
            break;
        // export HoistableDeclaration
        case 274519 /* FunctionKeyword */:
            declaration = this.parseFunctionDeclaration(context | 32768 /* Export */);
            break;
        // export HoistableDeclaration
        case 69740 /* AsyncKeyword */:
            if (this.nextTokenIsFuncKeywordOnSameLine(context)) {
    ...
    switch (this.token) {
        ...
        case 8671304 /* LetKeyword */:
            ...
            if (this.isLexical(context))
                { return this.parseVariableStatement(context |= (2048 /* DisallowFor */ | 8388608 /* Let */)); }
            return this.parseStatement(context);
        case 8663113 /* ConstKeyword */:
            return this.parseVariableStatement(context | (2048 /* DisallowFor */ | 16777216 /* Const */));
...
Parser.prototype.parseBlockStatement = function parseBlockStatement (context) {
    ...
    this.blockScope = context & 4096 /* IfClause */ ? blockScope : undefined;
    this.expect(context, 393228 /* LeftBrace */);
...
Parser.prototype.parseCatchClause = function parseCatchClause (context) {
    ...
    var body = this.parseBlockStatement(context | 4096 /* IfClause */);
    this.blockScope = blockScope;
    if (blockScope !== undefined)
        { this.parentScope = parentScope; }
    return this.finishNode(pos, {
    ...
    if (this.token !== 17 /* Semicolon */) {
        if (hasMask(this.token, 8650752 /* VarDeclStart */)) {
            ...
            if (this.parseOptional(context, 8663111 /* VarKeyword */)) {
                ...
                state |= 4 /* Let */;
                declarations = this.parseVariableDeclarationList(context | 8388608 /* Let */);
            }
            else if (this.parseOptional(context, 8663113 /* ConstKeyword */)) {
                state |= 2 /* Const */;
                declarations = this.parseVariableDeclarationList(context | 16777216 /* Const */);
            }
            ...
            init = this.parseExpression(context & ~4 /* AllowIn */ | 2048 /* DisallowFor */, pos);
        }
    }
    this.flags = savedFlag;
    switch (this.token) {
        ...
        case 69746 /* OfKeyword */:
            ...
            this.expect(context, 16 /* RightParen */);
            this.flags |= (32 /* Continue */ | 16 /* Break */);
            body = this.parseStatement(context | 2048 /* DisallowFor */);
            this.flags = savedFlag;
            return this.finishNode(pos, {
                type: 'ForOfStatement',
                body: body,
...
Parser.prototype.parseFunctionDeclaration = function parseFunctionDeclaration (context) {
    ...
    if (this.token === 69740 /* AsyncKeyword */) {
        ...
        if (!(this.flags & 4 /* InFunctionBody */))
            { context |= 2097152 /* AsyncFunctionBody */; }
    }
    ...
    if (context & 32768 /* Export */ && this.token === 393217 /* Identifier */)
    ...
    if (this.token !== 262155 /* LeftParen */ && this.isIdentifier(context, this.token)) {
        ...
        if (hasMask(this.token, 12288 /* Reserved */))
            { this.error(1 /* UnexpectedToken */, tokenDesc(this.token)); }
        if (context & 2097152 /* AsyncFunctionBody */) {
            if (this.token === 331885 /* AwaitKeyword */)
                { this.error(1 /* UnexpectedToken */, tokenDesc(this.token)); }
            if (!(context & 32 /* Await */))
                { context &= ~2097152 /* AsyncFunctionBody */; }
        }
        if (context & 512 /* Statement */ && !(context & 8192 /* AnnexB */)) {
    ...
    var params = this.parseParameterList(context & ~(512 /* Statement */ | 65536 /* OptionalIdentifier */) | 128 /* InParameter */);
    var body = this.parseFunctionBody(context & ~(512 /* Statement */ | 65536 /* OptionalIdentifier */));
...
Parser.prototype.parseVariableDeclaration = function parseVariableDeclaration (context) {
    ...
    if (context & 25165824 /* Lexical */) {
        ...
        else if (context & 2048 /* DisallowFor */ && id.type !== 'Identifier' || this.token === 1310749 /* Assign */) {
        ...
        else if (id.type !== 'Identifier' && context & 2048 /* DisallowFor */) {
            this.expect(context, 1310749 /* Assign */);
        }
    }
    return this.finishNode(pos, {
...
Parser.prototype.parseAssignmentExpression = function parseAssignmentExpression (context) {
    ...
    if (hasMask(this.token, 1310720 /* AssignOperator */)) {
        ...
        if (!(context & 128 /* InParameter */) && this.token === 1310749 /* Assign */) {
...
Parser.prototype.parseFunctionExpression = function parseFunctionExpression (context, pos) {
    ...
    var savedScope = this.enterFunctionScope();
    var params = this.parseParameterList(context | 128 /* InParameter */);
...
Parser.prototype.parseClassElement = function parseClassElement (context, state) {
    ...
    if (!(state & 16 /* Computed */)) {
        ...
        if (!(state & 2048 /* Static */) && state & 512 /* HasConstructor */) {
            ...
            if (context & 524288 /* HasConstructor */)
...
Parser.prototype.parseParenthesizedExpression = function parseParenthesizedExpression (context) {
    ...
    if (this.parseOptional(context, 16 /* RightParen */)) {
        if (this.token === 10 /* Arrow */)
            { return this.parseArrowFunction(context & ~32 /* Await */, pos, []); }
    ...
    if (this.token === 18 /* Comma */) {
        ...
        while (this.parseOptional(context, 18 /* Comma */)) {
            if (this$1.parseOptional(context, 16 /* RightParen */)) {
                return this$1.parseArrowFunction(context, pos, expressions);
            }
            else if (this$1.token === 14 /* Ellipsis */) {
                expressions.push(this$1.parseRestElement(context));
                this$1.expect(context, 16 /* RightParen */);
                return this$1.parseArrowFunction(context & ~32 /* Await */, pos, expressions);
            }
            else {
                if (context & 2 /* Strict */) {
                    if (!(state & 1 /* EvalOrArg */) && this$1.isEvalOrArguments(this$1.tokenValue)) {
...
Parser.prototype.parseLiteral = function parseLiteral (context) {
    ...
    var value = this.tokenValue;
    var raw = this.tokenRaw;
    if (context & 2 /* Strict */ && this.flags & 512 /* Noctal */) {
        this.error(0 /* Unexpected */);
    }
    this.nextToken(context);
    var node = this.finishNode(pos, {
...
Parser.prototype.parseBindingPatternOrIdentifier = function parseBindingPatternOrIdentifier (context, pos) {
    switch (this.token) {
        ...
        case 331885 /* AwaitKeyword */:
            ...
            return this.parseBindingIdentifier(context);
        case 282730 /* YieldKeyword */:
            this.flags |= 256 /* FirstRestricted */;
            if (context & 16 /* Yield */)
                { this.error(91 /* DisallowedInContext */, tokenDesc(this.token)); }
        case 8671304 /* LetKeyword */:
            if (context & 25165824 /* Lexical */)
        ...
        loop: while (this.hasNext()) {
            switch (this$1.token) {
                case 25 /* JSXClose */:
                    break loop;
                default:
                    children.push(this$1.parseJSXChild(context | 16384 /* JSXChild */));
            }
        }
...
Parser.prototype.parseJSXChild = function parseJSXChild (context) {
    switch (this.token) {
        ...
        // '{'
        case 393228 /* LeftBrace */:
            return this.parseJSXExpressionContainer(context &= ~16384 /* JSXChild */);
        // '<'
