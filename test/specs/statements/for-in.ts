...
describe('Statements - For in', () => {
    ...
    it('should throw on "for(({a}) in 0);"', () => {
        expect(function() { parseScript('for(({a}) in 0);')}).to.not.throw();
    });
    ...
    it.skip('should parse head declaration expression', () => {
    ...
    it.skip('should parse "for(var a in b, c);"', () => {
    ...
    it.skip('should parse "for(a in b, c);"', () => {
    ...
    it.skip('should parse "for({a=0} in b);"', () => {
  ...
  {}`, {
    ...
    it.skip('should parse expression in head', () => {
        expect(parseScript(`for (x in null, { key: 0 }) {}`, {
            ranges: true,
            raw: true,
            next: true
