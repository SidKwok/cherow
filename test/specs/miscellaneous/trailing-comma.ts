...
describe('Trailing comma', () => {
    ...
    it.skip('should fail on invalid export', () => {
        expect(() => {
            parseModule('export default function foo(,) { }');
        }).to.throw();
    });
    it.skip('should fail on invalid export default', () => {
        expect(() => {
            parseModule('export default (function foo(,) { })');
        }).to.throw();
    });
    ...
    it.skip('should parse trailing comma arrow single', () => {
    ...
    it.skip('should parse trailing comma arrow multi', () => {
    ...
    it.skip('should parse trailing comma export default', () => {
    ...
    it.skip('should parse trailing comma export function', () => {
