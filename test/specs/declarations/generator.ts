...
describe('Statements - Generator', () => {
    ...
    it.skip('should fail on yield as parameter', () => {
        expect(() => {
    ...
    it.skip('should fail on "label: function* a(){}"', () => {
        expect(() => {
            parseScript('label: function* a(){}');
        }).to.throw('');
    });

    it.skip('should fail on "function*g(yield){}"', () => {
        expect(() => {
            parseScript('function*g(yield){}');
        }).to.throw('');
    });
    ...
    it.skip('should fail on "function*g({a: yield}){}"', () => {
        expect(() => {
            parseScript('function*g({a: yield}){}');
        }).to.throw('');
    });
    it.skip('should fail on "function*g(yield = 0){}"', () => {
        expect(() => {
            parseScript('function*g(yield = 0){}');
        }).to.throw('');
    });
    it.skip('should fail on "function*g(){ var yield; }"', () => {
        expect(() => {
            parseScript('function*g(){ var yield; }');
        }).to.throw('');
    });
    it.skip('should fail on "function*g(){ var yield = 1; }"', () => {
        expect(() => {
            parseScript('function*g(){ var yield = 1; }');
        }).to.throw('');
    });
    it.skip('should fail on "function*g(){ function yield(){}; }"', () => {
        expect(() => {
    ...
    it.skip('should fail on "function*g() { let yield; }"', () => {
        expect(() => {
            parseScript('function*g() { let yield; }');
        }).to.throw('');
    });
    it.skip('should fail if on "function*g() { try {} catch (yield) {} }"', () => {
        expect(() => {
    ...
    it.skip('should fail if on "function*g() { for ({yield} in 0); }"', () => {
        expect(() => {
            parseScript('function*g() { for ({yield} in 0); }');
        }).to.not.throw('');
    });
    it.skip('should fail if on "function*g() { ({yield = 0}); }"', () => {
        expect(() => {
            parseScript('function*g() { ({yield = 0}); }');
        }).to.not.throw('');
    });
    it.skip('should fail if on "function*g() { ({yield = 0} = 0); }"', () => {
        expect(() => {
            parseScript('function*g() { ({yield = 0} = 0); }');
        }).to.not.throw('');
    });
    it.skip('should fail if on "function*g() { var {yield = 0} = 0; }"', () => {
        expect(() => {
            parseScript('function*g() { var {yield = 0} = 0; }');
          }).to.not.throw('');
    });

    it.skip('should fail if on "function*g() { for ({yield = 0} in 0); }"', () => {
        expect(() => {
