...
describe('Declarations - Lexical', () => {
    ...
    it.skip('should fail on let newline await in normal function', () => {
        expect(() => {
    ...
    it.skip('should fail on let: |let let| split across two lines', () => {
        expect(() => {
            parseScript(`let 
    let;`)
        }).to.throw();
    ...
    it.skip('should fail if "this" are used as an shorthand property"', () => {
        expect(() => {
    ...
    it.skip('should parse deconstructed rest object with getter', () => {
    ...
    it.skip('should parse binding as specified via property name and identifier (`let` statement)', () => {
    ...
    it.skip('should parse assignment of function `name` attribute', () => {
    ...
    it.skip("should parse \"const [{ u: v, w: x, y: z } = { u: 444, w: 555, y: 666 }] = [{ u: 777, w: 888, y: 999 }];\"", () => {
    ...
    it.skip("should parse \"{ const x = 14, y = 3, z = 1977 }\"", () => {
    ...
    it.skip("should parse \"let [{ x, y, z } = { x: 44, y: 55, z: 66 }] = [{ x: 11, y: 22, z: 33 }];\"", () => {
    ...
    it.skip("should parse \"let { x, } = { x: 23 };\"", () => {
    ...
    it.skip("should parse \"let { x: y } = { x: 23 };\"", () => {
    ...
    it.skip("should parse \"let { w: { x, y, z } = { x: 4, y: 5, z: 6 } } = { w: { x: undefined, z: 7 } };\"", () => {
    ...
    it.skip("should parse \"const {a, b, ...rest} = {x: 1, y: 2, a: 5, b: 3};\"", () => {
    ...
    it.skip('should parse lexical conditional binary numbers', () => {
